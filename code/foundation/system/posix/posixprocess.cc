...
*/
void
PosixProcess::UpdateStdoutStream()
{
...
*/
bool
PosixProcess::CheckIfExists(const IO::URI & program)
{
    //FIXME: not implemented
    return false;
}
